                                                ...
                                                double                  t)
{
  ...
  double chi_prefac    = std::pow(particle.GetUnitSystem().UNIT_LENGTH,2)*std::pow(particle.GetUnitSystem().UNIT_ENERGY,-1)*std::pow(particle.GetUnitSystem().UNIT_TIME,-3)/particle.GetMass();
