...
struct StrattoMosaicConfig
{
    ...
    double zernike_rmax_;         // Radius of the Zernike polynomial pupul.
...
int main(int argc, char* argv[])
{
    ...
    conf_file.open("configStrattoMosaicSGZernike.xml");
    ...
    MosaicBeams<2>    *  mosaic       = new MosaicBeams<2>(mesh_parabola,zernike_beam,config->number_tesserae_);
